 ...
 *
 * Folder-scoped, like the active expert, and read against the folder the side
 * agent runs in: which identity to run under is a property of the project
 * rather than of the machine, so each folder of a multi-root workspace keeps
 * its own.
 */
  ...
  properties: {
    ...
    [SPEXR_CLAUDE_ACTIVE_PROFILE_PREFERENCE]: {
      ...
      description:
        ...
        "including the folders of one multi-root workspace. " +
